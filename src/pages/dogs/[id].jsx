  ...
  return (
    ...
    <div className={`container mx-auto order-b border-gray-300`}>
      ...
      <div className="flex gap-8">
        <div className="w-[300px] h-[300px] bg-primary-gray flex items-center justify-center rounded-lg">
          <svg
            width="250"
            height="250"
            viewBox="0 0 211 198"
        ...
        <div className="flex-col">
          <div className="flex gap-4">
            <Chip label={dog.location} type={ChipTypeStyles[dog.location] || ChipTypeStyles.Tag} />
          ...
          <div className="flex space-x-16">
            <div className="flex-col pt-8 pl-1 text-lg space-y-2">
              <div>
                Birth Date: {dateutils.getDateString(new Date(dog.dateOfBirth))}
              </div>
