    ...
    <div className="h-screen flex flex-col items-center justify-between">
      <div className="h-4/5 w-screen flex flex-col items-center justify-evenly m-1">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <button onClick={() => signIn("google", { callbackUrl: `${window.location.origin}/dogs` })} className="font-roboto text-tertiary-gray w-80 py-3 rounded-sm bg-white outline outline-black outline-1 flex flex-row items-center justify-center text-2xl">
