...
export default function Navbar() {
  ...
  return (
    <div className="flex h-20 bg-foreground items-stretch justify-between gap-4">
      ...
      <div className="pl-10 mt-5"><Image
              src={CALogo}
    ...
    <Link
        ...
        className={
            ...
            (currentPage == "/dogs" ? "border-opacity-100" : "border-opacity-0 hover:border-opacity-100")
        }
      ...
      <Link
        ...
        className={
          "flex flex-col justify-center w-fit h-full border-b-4 " +
          (currentPage == "/users" ? "border-ca-green " : "border-gray-400 ") +
          (currentPage == "/users" ? "border-opacity-100" : "border-opacity-0 hover:border-opacity-100")
      }
        onClick={() => setCurrentPage(router.pathname)}
      >
        <div className="text-center text-primary-text text-lg font-semibold px-3">
  ...
  className={
    ...
    (isDropdownVisible ? "border-opacity-100" : "border-opacity-0 hover:border-opacity-100")
  }
>
{/* className={
    "flex items-center justify-center h-full border-b-4 " +
    (currentPage == "/account" ? "border-ca-green " : "border-gray-400 ") +
    (currentPage == "/account" ? "border-opacity-100" : "border-opacity-0 hover:border-opacity-100")
  } */}
  <div className="flex items-center justify-center">
    ...
    <svg className="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
        ...
        {isDropdownVisible && (
      <div className="absolute right-0 mt-7 w-48 bg-white rounded-md shadow-lg z-20">
...
<button
  className={
    "w-full text-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 border-b-6 " +
    (currentPage == "/account" ? "border-ca-green " : "border-gray-400 ") +
    (currentPage == "/account" ? "border-opacity-100" : "hover:border-opacity-100")
  }
...
>
  Settings
        ...
        <button
          onClick={() => signOut()}
          className="w-full text-center px-4 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200"
        >
          Log Out
        </button>
      </div>
